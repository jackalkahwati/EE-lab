"""DFM quality gate — FL-1 calibration board Rev A.
...
Writes elec/layout/cal-rev-a/output/dfm_profile_check.json; exits 1 on FAIL.
"""
import json
import os
import re
...
BOARD = sys.argv[1] if len(sys.argv) > 1 else os.path.join(
    ...
    "..", "elec", "layout", "cal-rev-a", "cal-rev-a.kicad_pcb")
EDGE_MM          = 3.0
HOLE_KEEPOUT_MM  = 3.5
CY_GAP_MM        = 0.4
