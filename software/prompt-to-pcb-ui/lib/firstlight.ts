...
export interface Run {
  ...
  runDir?: string
  /** rev lineage: the run this one was revised from, and why */
  parentId?: string
  revNote?: string
}
...
export const STAGE_DEFS: StageDef[] = [
  ...
  },
  {
    ...
    tool: 'flroute',
    gate: 'EMISSION GATE',
    substeps: ['DSN export', 'PathFinder negotiation', 'consolidation'],
    durationMs: 35000,
  },
  {
    id: 'validation',
...
const passedLogs: LogLine[] = [
  ...
  { stage: 'routing', prefix: 'route', text: 'PathFinder negotiation: pass 1, 121/174 routed' },
  { stage: 'routing', prefix: 'route', text: 'PathFinder + txn swaps + second chance, 174/174 routed' },
  { stage: 'routing', prefix: 'route', text: 'consolidation: all pockets resolved (deepening + second-chance sweep)' },
  { stage: 'routing', prefix: 'route', text: 'GATE emission: 174 DRC-clean nets shipped, 0 dirty nets emitted, PASS', level: 'ok' },
