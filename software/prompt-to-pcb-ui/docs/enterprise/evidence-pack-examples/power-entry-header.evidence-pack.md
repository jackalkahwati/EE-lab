# Evidence pack — Power Entry Header v1 (synthesized, routed, DRC clean)

*scope: run · generated 2026-07-08T08:42:38.958Z · reproducible
from `public/runs/power-entry-header-v1`*

## 1. Executive summary
Power Entry Header v1 (synthesized, routed, DRC clean): highest PROVEN state is 'package_ready'; 2 blocked claim(s); physical evidence ledger EMPTY
...
## 2-4. Intent
- Prompt: Simple Power Entry Header (PURE SYNTHESIS)
- Board class: Simple Power Entry Header Board v1

## 5-7. Artifacts
- PCB artifacts: B.Cu.svg, Edge.Cuts.svg, F.Cu.svg, F.SilkS.svg, In1.Cu.svg, In2.Cu.svg, render-bottom.png, render-top.png
- BOM: public/runs/power-entry-header-v1/data/bom.json
