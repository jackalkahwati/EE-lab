...
- Fab profiles' `hole_clearance` is JLCPCB's published rule (capabilities page, read 2026-09-06): standard 0.35 mm (their recommended PTH-to-track; minimum 0.28), HDI 0.3 mm (inner-layer PTH hole to copper). It was 0.5/0.4 — self-imposed, and the source of most "hole_clearance" errors on boards with headers. Via keep-out, THT inflation and the legalizer margin derive from it.
