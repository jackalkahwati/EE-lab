/** E7 regression: fab/quote workflow (isolated synthetic artifacts + store). */
import { withEnterpriseFixture } from './enterprise_test_fixture.mjs'

await withEnterpriseFixture('e7', ['approvals', 'quotes'], async (fixture) => {
  fixture.routedRun('power-entry-header-v1')
  fixture.artifact('power-entry-header-v1', 'bom.json', {
    components: [{ reference: 'R1', value: '1k', synthetic: true }],
  })
  fixture.artifact('power-entry-header-v1', 'pick_and_place.csv',
    'Reference,Value,PosX,PosY,Rotation,Side\nR1,1k,1,1,0,top\n')
  const ent = await fixture.importModule('store')
  const apr = await fixture.importModule('approvals')
  const qt = await fixture.importModule('quotes')
  ...
  check('3 packet generated from synthetic run artifacts (BOM + P&P + DRC/ERC)',
